...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    //       ' no-store, no-cache, must-revalidate, post-check=0, pre-check=0',
    //   'set-cookie':
    //       'PHPSESSID=UPDATED; path=/; secure; HttpOnly,hsid=94cad1556e9fd056c30e227cd307a252653422a1; path=/; secure,edid=W0mTqe4bJ5VgvHc7zMySAb2KOPuYa8; expires=Fri, 13-Sep-2024 05:34:16 GMT; Max-Age=94608000; path=/; secure; HttpOnly',
    //   'transfer-encoding': 'chunked',
    //   'date': 'Tue, 14 Sep 2021 05:34:16 GMT',
    //   'content-encoding': 'gzip',
    //   'vary': 'Accept-Encoding',
